...
first_stage_7 <- lm(treat ~ assign + assign_grain_dum + assign_yuca_dum, data = nic_rct)
first_stage_7_simple <- lm(treat ~ assign, data = nic_rct)
s_fs_7 <- tidy(first_stage_7)
s_fs_y_s <- tidy(first_stage_7_simple)
nic_rct <- mutate(nic_rct, treat_hat_7 = fitted(first_stage_7))
glance(first_stage_7)$statistic
glance(first_stage_7_simple)$statistic
...
Charlotte's take: $\beta^{2sls}$ will be consistent for $\beta$; however, comparing the F statistics for the first stages, 
