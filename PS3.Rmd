...
f_fs_7 <- glance(first_stage_7)$statistic
f_fs_7_s <- glance(first_stage_7_simple)$statistic
...
lh <- linearHypothesis(first_stage_7,c("assign_grain_dum = 0", "assign_yuca_dum = 0"), test = "F")
p <- lh[2,6]
f <- lh[2,5]
