...
Specifically, since $ATT = E[income_{1,i}|treat_i=1] - E[income_{0,i}|treat_i=1]$, where numerical subscripts represent assignment to treatment and control respectively, $= E[income_{1,i}|treat_i=1] + E[income_{1,i}|treat_i=0] - E[income_{0,i}|treat_i = 1] - E[income_{0,i}|treat_i =0]$
